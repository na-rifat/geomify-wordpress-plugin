<?php
    $fields = \geomify\Schema\Schema::get( 'profile_facilitator' );
    $fields = \geomify\Processor\Processor::add_name_to_inputs($fields);
    $fields = \geomify\Processor\Processor::add_values_to_schema($fields, \geomify\Processor\Processor::get_user_package_info('facilitator'));
...
<div class="profile-section" data-profile_package="faclitator">
    ...
    <div class="profile-row">
        <form action="#" method="POST">
            <div class="profile-col">
                <h2>FACILITATOR user information</h2>
