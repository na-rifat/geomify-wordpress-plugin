<?php
    $fields = \geomify\Schema\Schema::get( 'profile_creator' );
    $fields = \geomify\Processor\Processor::add_name_to_inputs( $fields );
    $fields = \geomify\Processor\Processor::add_values_to_schema($fields, \geomify\Processor\Processor::get_user_package_info('creator'));
...
<div class="profile-section" data-profile_package="creator">
