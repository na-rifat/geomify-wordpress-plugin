<?php
    $fields = \geomify\Schema\Schema::get( 'profile_free' );
    $fields = \geomify\Processor\Processor::add_name_to_inputs($fields);
    $fields = \geomify\Processor\Processor::add_values_to_schema($fields, \geomify\Processor\Processor::get_user_package_info('free'));
...
<div class="profile-section" data-profile_package="free">
