<?php
    $fields = \geomify\Schema\Schema::get( 'profile_enterprise' );
    $fields = \geomify\Processor\Processor::add_name_to_inputs($fields);
    $fields = \geomify\Processor\Processor::add_values_to_schema($fields, \geomify\Processor\Processor::get_user_package_info('enterprise'));
...
<div class="profile-section" data-profile_package="enterprise">
    ...
    <div class="profile-row">
        <form action="#" method="POST">
            <div class="profile-col">
                <h2>CREATOR user information</h2>
