                ...
                <form action="" class="payment-form payment-card">
                    ...
                    <div class="payment-box">
                        <div class="payment-input-group">
                            <input type="text" placeholder="1234 1234 1234 1234" name="card_number" id="card_number" required min="16" max="16">
                        </div>
                        <div class="payment-input-group have-expiry">
                            <input type="text" placeholder="MM" name="expire_month" id="expire_month" required min="2" max="2">
                            <input type="text" placeholder="YYYY" name="expire_year" id="expire_year" required min="2" max="2">
