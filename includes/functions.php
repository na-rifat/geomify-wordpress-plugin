<?php
    ...
    if ( ! function_exists( 'cssfile' ) ) {
        function cssfile( $filename, $deps = [] ) {
            return ['src' => GEOMIFY_CSS_URL . "/{$filename}.css", 'version' => cssversion( $filename ), 'deps' => $deps];
        }
    }
    ...
    if ( ! function_exists( 'jsfile' ) ) {
        function jsfile( $filename, $deps = [] ) {
            return ['src' => GEOMIFY_JS_URL . "/{$filename}.js", 'version' => jsversion( $filename ), 'deps' => $deps];
        }
    }
     ...
     * @return void
     */
    if ( ! function_exists( 'icofile' ) ) {
        function icofile( $filename ) {
